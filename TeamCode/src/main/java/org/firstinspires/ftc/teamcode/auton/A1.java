...
public class A1 extends ScheleteAutonomie {
    ...
    public void runOpMode()
    {
        ...
        Pose2d startPos = new Pose2d(-63, -31.43f , Math.toRadians(0));
        ...
        Trajectory traj3 = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-15, -11f, Math.toRadians(0)))
                .build();

        Trajectory traj4 = drive.trajectoryBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(-15, -34, Math.toRadians(0)))
                .build();

        Trajectory traj5 = drive.trajectoryBuilder(traj0.end())
                .lineToLinearHeading(new Pose2d(-62, -57f, Math.toRadians(0)))
                .build();
