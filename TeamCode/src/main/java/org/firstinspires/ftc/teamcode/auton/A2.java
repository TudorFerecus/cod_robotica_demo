...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Autonomy: Albastru 2", group="Autonomy")
public class A2 extends ScheleteAutonomie {
    ...
    public void runOpMode()
    {
        ...
        Pose2d startPos = new Pose2d(-63, 36f , Math.toRadians(0));
        ...
        Trajectory traj1 = drive.trajectoryBuilder(traj0.end())
                .lineToLinearHeading(new Pose2d(-62, 11f, Math.toRadians(0)))
                .build();

        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-36, 11f, Math.toRadians(0)))
                .build();

        Trajectory traj3 = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-16, 11f, Math.toRadians(0)))
                .build();

        Trajectory traj4 = drive.trajectoryBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(-16, 37, Math.toRadians(0)))
                .build();

        Trajectory traj5 = drive.trajectoryBuilder(traj0.end())
                .lineToLinearHeading(new Pose2d(-62, 55f, Math.toRadians(0)))
                .build();

        Trajectory traj6 = drive.trajectoryBuilder(traj5.end())
                .lineToLinearHeading(new Pose2d(-39, 57f, Math.toRadians(0)))
                .build();
