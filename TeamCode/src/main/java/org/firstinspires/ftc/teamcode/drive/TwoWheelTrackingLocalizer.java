...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 11.3 / 2.54; // X is the up and down direction
    public static double PARALLEL_Y = -3.2 / 2.54; // Y is the strafe direction

    public static double PERPENDICULAR_X = -14 / 2.54;
