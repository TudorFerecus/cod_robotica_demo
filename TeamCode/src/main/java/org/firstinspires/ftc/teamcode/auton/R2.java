...
public class R2 extends ScheleteAutonomie {
    ...
    public void runOpMode()
    {
        ...
        Pose2d startPos = new Pose2d(63, 31.43f , Math.toRadians(180));
        ...
        Trajectory traj3 = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(15, 11f, Math.toRadians(180)))
                .build();

        Trajectory traj4 = drive.trajectoryBuilder(traj3.end())
                .lineToLinearHeading(new Pose2d(15, 34, Math.toRadians(180)))
                .build();
